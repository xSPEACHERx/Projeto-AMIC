            ...
            <ul class="nav nav-pills">
              <li class="nav-item container-fluid">
                <div class="input-group rounded">
                    <input type="search" class="form-control rounded" placeholder="id, data, tipo ou status" aria-label="Buscar" aria-describedby="search-addon" id="myInput"/>
                ...
                <?php
                    // preenche a tabela com os dados
                        foreach($dados as $row){
                            ...
                            echo "<td>";
                            echo "  <form action='../maquinas/maquina.php?code=$idmaquina' method='post'>";
