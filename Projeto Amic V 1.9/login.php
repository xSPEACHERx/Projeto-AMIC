...
// Verifica se o usuario já está logado em uma conta, caso sim ele vai para o menu ou para a pagina da maquina se escaneu qr code
...
// caso tenha o codigo de uma maquina adiciona no link od cadastro.php
    if (isset($_GET['code'])){
        $linkcad = "cadastro.php?code=".$_GET['code'];
    } else {
        $linkcad = "cadastro.php";
    }

// se o cadastro foi realizado com sucesso exibe mensagem
    ...
    <div class="container col-sm-12 col-md-6 " style="margin-top: 2%;">
        ...
        <div class="card">
            <article class="card-body">
                ...
                <p class="text-center">Não está cadastrado? <a href="cadastro.php">Cadastre-se</a></p>
