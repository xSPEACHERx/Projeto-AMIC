<?php 
    ...
    $sql = "SELECT maquina_idmaquina, re_data, re_tipo, re_feedback_data FROM reporte ORDER BY re_data DESC";
    ...
    <div class="offcanvas offcanvas-end bg-dark" style="width: 270px ;" id="demo">
        ...
        <div class="offcanvas-body">
            <ul class="">
                ...
                <li class="nav-item">
                    <a class="nav-link" style="color: rgba(255, 255, 255, 0.712) ; font-size: larger;" href="maquinas-tec.php">Máquinas</a>
                </li>
            </ul>
            <ul class="">
            ...
            <ul class="nav nav-pills">
                <li class="nav-item">
                    <div class="input-group rounded">
                        <input type="search mr-sm-10" class="form-control rounded" placeholder="id, data, tipo ou status" id="myInput"/>
            ...
            <table class="table table-hover table-striped table-bordered">
                ...
                <tbody align="center" id="myTable">
                    ...
                    foreach($dados as $row){
                        ...
                        echo "<td>";
                        echo "  <form action='../maquinas/maquina-tec.php?code=$idmaquina' method='post'>";
                        echo "     <button type='submit' class='btn btn-primary'>Ir para máquina</button>";
                        echo "  </form>";
                        echo "</td>";
                        echo "</tr>";
