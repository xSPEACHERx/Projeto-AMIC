...
$link = 'https://'.$ipv4.'/'.$versao.'/maquinas/maquina-tec.php?code='.$idmaquina;
...
$statement->execute([':idmaquina' => $idmaquina]);
        ...
        <div class="col-md-8">
          <div class="card mb-3">
            <div class="card-body">
              ...
              <div class="row">
                <div class="col-sm-10">
                  <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#myModal">Editar</button>
                  <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#excluir">Excluir máquina</button>
                </div>
                <div class="col-sm-2 ">
                  <button type="button" class="btn btn-primary text-white" data-bs-toggle="modal" data-bs-target="#qrcode">QR code</button>
                </div>
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        ...
                        <form action="../php/insert-feedback.php?code=<?php echo $idmaquina ?>&id=<?php echo $row['idreporte'] ?>" method="POST">
                          ...
                          <div class="mb-3">
                            ID Máquina: <?php echo $idmaquina ?> <br>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <form action="../php/delete-maquina.php?code=<?php echo $idmaquina ?>" method="POST">
            ...
            <div class="mb-3">
              <?php echo '<img src="'.(new \chillerlan\QRCode\QRCode())->render($link).'" alt="QR Code" />'; ?>
            </div>

            <div class="modal-footer">
              <button type="button" class="btn btn-primary">Baixar PDF</button>
        ...
        <div class="modal-body">
          ...
          <form action="../php/delete-maquina.php?code=<?php echo $idmaquina ?>" method="POST">
            ...
            <div class="mb-3">
              ...
              Tem certeza de que deseja DELETAR essa máquina?
            </div>
