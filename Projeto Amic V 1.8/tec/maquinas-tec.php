                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="../php/cadastro-maquina.php" method="post">
                            <div class="mb-3">
                                <label class="form-label required">Quantidade de maquinas (clones)</label>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-control" name="cadastro-maquina-local" placeholder="Status"
                                    ...
                                    <option value="Lab 3">Lab de redes</option>
                                    <option value="Lab 3">Lab Maker</option>
                                    <option value="Lab 3">Lab Especial</option>
                                </select>
                            </div>
                            <div class="mb-3">
