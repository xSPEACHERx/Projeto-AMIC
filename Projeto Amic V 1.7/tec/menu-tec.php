...
<body>
    ...
    <div class="offcanvas-body">
        <ul class="">
            <li class="nav-item">
                <a class="nav-link active" style="color: white ; font-size: larger;" href="menu-tec.html">Início</a>
            </li>
            <li class="nav-item">
    ...
    <div class="container" style="height: 100%;">
        ...
        <div class="container" style="padding-bottom: 8%;">
            <div class="row">
                ...
                <div class="col-md-4 text-center" style="margin-top: 6%;">
                    <a href="../tec/ver-relatorios.html"><img src="https://cdn-icons-png.flaticon.com/512/4022/4022015.png"
                            alt="Usuario" style="width:100px;height:100px;">
