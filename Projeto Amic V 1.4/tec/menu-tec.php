...
<body>
            ...
            <div class="navbar-collapse collapse" id="navbarsExample05" style="margin-top: 1%;">
              ...
              <ul class="navbar-nav ml-auto">
                <li class="nav-item cta-btn">
                  <a class="nav-link" href="../php/logout-tecnico.php" style="color: rgba(255, 0, 0, 0.801);">Desconectar</a>
                </li>
              </ul>
            </div>
          </div>
    ...
    <div class="offcanvas-body">
        <ul class="">
            <li class="nav-item">
                <a class="nav-link active" style="color: white ; font-size: larger;" href="menu-tec.html">Inicío</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" style="color: rgba(255, 255, 255, 0.712) ; font-size: larger;" href="dados-pessoais-tec.html">Dados Pessoais</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" style="color: rgba(255, 255, 255, 0.712) ; font-size: larger;" href="ver-relatorios-tec.html">Ver Relatórios</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" style="color: rgba(255, 255, 255, 0.712) ; font-size: larger;" href="maquinas-tec.html">Maquinas</a>
            </li>
        </ul>
        <ul class="">
            <li class="nav-item cta-btn">
                <a class="nav-link" href="../login.html"
                    style="color: rgba(255, 0, 0, 0.801);  font-size: larger;" href="../php/logout-tecnico.php">Desconectar</a>
            </li>
        </ul>
        ...
        <div class="container" style="padding-bottom: 8%;">
            <div class="row">
                <div class="col-md-4 text-center" style="margin-top: 6%;">
                    <a href="dados-pessoais-tec.html"><img src="https://cdn-icons-png.flaticon.com/512/3524/3524761.png"
                ...
                <div class="col-md-4 text-center" style="margin-top: 6%;">
                    <a href="ver-relatorios-tec.html"><img src="https://cdn-icons-png.flaticon.com/512/4022/4022015.png"
                            alt="Usuario" style="width:100px;height:100px;">
