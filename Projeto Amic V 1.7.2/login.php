    ...
    <div class="container col-sm-12 col-md-6 " style="margin-top: 2%;">
        ...
        <div class="card">
            <article class="card-body">
                ...
                <!-- Botões para trocar a versão entre aluno e tecnico -->
                <div class="btn-group mb-4 col-md-12" role="group">
                    <button type="button" class="btn btn-secondary activated" id="aba-aluno-login"
                        onclick="estadoAlunoLogin()">Aluno</button>
                    <button type="button" class="btn btn-secondary" id="aba-tecnico-login"
                        onclick="estadoTecnicoLogin()">Técnico</button>
                </div>

                <div class="conteudos">
                    <!-- Login Usuário -->
                    <div id="aluno-login">
                        <form action="php/sistema-login.php?form=1<?php if(isset($_GET['code'])){echo '&code='.$_GET['code'];} ?>" method="post">
                            <div class="form-group">
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text"> <i class="fa fa-user"></i> </span>
                                    </div>
                                    <input name="login-usuario-email" class="form-control" placeholder="Email"
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input name="login-usuario-senha" class="form-control" placeholder="Senha"
                    ...
                    <!-- Login técnico -->
                    <div id="tecnico-login" class="hide">
                        <form action="php/sistema-login.php?form=2<?php if(isset($_GET['code'])){ echo '&code='.$_GET['code'];} ?>" method="post">
                            <div class="form-group">
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text"> <i class="fa fa-user"></i> </span>
                                    </div>
                                    <input name="login-tecnico-email" class="form-control" placeholder="Email"
                                        type="text" maxlength="50" required>
                                </div> <!-- input-group.// -->
                            </div> <!-- form-group// -->
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input name="login-tecnico-senha" class="form-control" placeholder="Senha" type="password"
                ...
                <div class="form-group">
                    <div class="form-group d-md-flex" style="margin-top: 3%;">
                        ...
                        <div class="w-50 text-md-right">
                            <a href="recuperar senha/senha-esquecida-email.html">Esqueceu a senha?</a>
                        </div>
                    </div>
                </div>
