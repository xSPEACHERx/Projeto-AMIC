...
<body>
            ...
            <div class="container">
                ...
                <div class="navbar-collapse collapse" id="navbarsExample05" style="margin-top: 1%;">
                    <ul class="navbar-nav ml-auto pl-lg-5 pl-0">
                        <li class="nav-item">
                            <a class="nav-link active" href="../usuario/menu.php">Início</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="../usuario/dados-pessoais.php">Dados Pessoais</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item cta-btn">
                            <a class="nav-link red" href="../php/logout-usuario.php" style="color: rgba(255, 0, 0, 0.801);">Desconectar</a>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <div class="offcanvas offcanvas-end bg-dark" style="width: 270px ;" id="demo">
        ...
        <div class="offcanvas-body">
            <ul class="">
                <li class="nav-item">
                <a class="nav-link " style="color: white ; font-size: larger;" href="../usuario/menu.php">Início</a>
                </li>
                <li class="nav-item">
                <a class="nav-link" style="color: rgba(255, 255, 255, 0.712) ; font-size: larger;" href="../usuario/dados-pessoais.php">Dados Pessoais</a>
                </li>
                <li class="nav-item">
            ...
            <ul class="">
                <li class="nav-item cta-btn">
                <a class="nav-link" href="../php/logout-usuario.php" style="color: rgba(255, 0, 0, 0.801);  font-size: larger;">Desconectar</a>
                </li>
            </ul>
    ...
    <div class="container">
        ...
        <div class="container text-right " style="margin-top: 15px;">
            <div class="container text-center col-sm-12 col-md-6" style="background-color: white;">
        ...
        <div class="container" style="padding-bottom: 8%;">
            <div class="row">
                <div class="col-md-4 col-sm-6 text-center" style="margin-top: 6%;">
                    <a href="../usuario/dados-pessoais.php"><img src="https://cdn-icons-png.flaticon.com/512/3524/3524761.png"
                            alt="Usuario" style="width:100px;height:100px;"></a>
                    <a href="../usuario/dados-pessoais.php">
                        <h3>Dados Pessoais</h3>
                    </a>

                </div>
                <div class="col-md-4 col-sm-6 text-center" style="margin-top: 6%;">
                    <a href="../usuario/relatar.html"><img src="https://cdn-icons-png.flaticon.com/512/7311/7311344.png"
                            alt="Usuario" style="width:100px;height:100px;"></a>
                ...
                <div class="col-md-4  col-sm-6 text-center" style="margin-top: 6%;">
                    <a href="../usuario/historico.html"><img src="https://cdn-icons-png.flaticon.com/512/7358/7358162.png"
                            alt="Usuario" style="width:100px;height:100px;"></a>
                    <a href="../usuario/historico.html">
                        <h3>Histórico</h3>
                    </a>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="container" style="padding-bottom: 8%; margin-top: 10%;">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 text-center">
                                                <a href="relatar.html"><img src="https://cdn-icons-png.flaticon.com/512/1384/1384063.png"
                                            ...
                                            <div class="col-md-4 text-center">
                                                <a href="historico.html"><img src="https://cdn-icons-png.flaticon.com/512/732/732200.png"
                                                        alt="Usuario" style="width:70px;height:70px;"></a>
