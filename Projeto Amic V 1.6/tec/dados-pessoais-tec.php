...
<body>
  ...
  <div class="offcanvas offcanvas-end bg-dark" style="width: 270px ;" id="demo">
    ...
    <div class="offcanvas-body">
      <ul class="">
        ...
        <li class="nav-item">
          <a class="nav-link" style="color: white ; font-size: larger;" href="dados-pessoais-tec.html">Dados
            Pessoais</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" style="color: rgba(255, 255, 255, 0.712) ; font-size: larger;"
            href="Ver relatorios.html">Ver
            Relatórios</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" style="color: rgba(255, 255, 255, 0.712) ; font-size: larger;"
  ...
  <div class="container">
    <div class="main-body">
      ...
      <!-- Botão voltar -->
      <a href="menu-tec.html"><img src="https://cdn-icons-png.flaticon.com/512/93/93634.png"
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-9 text-secondary">
                  <input type="text" class="form-control" name="update-tecnico-senha" value="<?php echo $senha ?>"
                    disabled>
                  <a href="../recuperar senha/senha-esquecida-email-dp.html"><input type="button"
