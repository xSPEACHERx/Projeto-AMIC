...
$sql2 = "SELECT * FROM reportes WHERE maquina_idmaquina=:idmaquina";
  ...
  <header role="banner">
    <nav class="navbar navbar-expand-md navbar-dark bg-dark ">
        ...
        <div class="navbar-collapse collapse" id="navbarsExample05" style="margin-top: 1%;">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="../tec/dados-pessoais-tec.php">Dados Pessoais</a>
            </li>
            <li class="nav-item">
            ...
            <table class="table table-hover  table-striped table-bordered">
              ...
              <tbody align="center">
                ...
                <?php foreach($dados2 as $row) {
                  ...
                  $idmodal= 'teste2'.strval(random_int(1,10000000));
                ...
                <tr>
                  ...
                  <td>
                    <p><?php echo $row['re_decricao']; ?></p>
                  </td>

                  <?php

                  $feedback = $row['re_feedback'];

                  if (!isset($row['re_feedback_data'])){
                    echo "<td><button type='button' class='btn btn-primary' data-bs-toggle='modal' data-bs-target='#$idmodal'>Adicionar</button></td>"; 
                  } echo "<td>$feedback</td>"
                    ?>
                </tr>

                <!-- Formulario para adicionar feedback -->
                <div class="modal" id="<?php echo $idmodal; ?>" style="margin-top: 5%;">
                  <div class="modal-dialog">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        ...
                        <form action="../php/insert-feedback.php?code=<?php echo $idmaquina ?>&id=<?php echo $row['idreportes'] ?>" method="POST">

                          <div class="mb-3">
                            ID Maquina: <?php echo $idmaquina ?> <br>
                            Id Report: <?php echo $row['idreportes'] ?>
                          </div>
                          <div class="mb-3">
