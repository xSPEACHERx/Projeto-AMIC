...
$consulta = $pdo->query("SELECT * FROM usuario WHERE matricula=$matricula");
      ...
      <div class="container">
        ...
        <div class="navbar-collapse collapse" id="navbarsExample05" style="margin-top: 1%;">
          <ul class="navbar-nav ml-auto pl-lg-5 pl-0">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="../usuario/dados-pessoais.php">Perfil</a>
            </li>
            <li class="nav-item">
      ...
      <ul class="">
        <li class="nav-item">
          <a class="nav-link " style="color: rgba(255, 255, 255, 0.712) ; font-size: larger;"
            href="menu.php">Início</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" style="color: white ; font-size: larger;" href="dados-pessoais.php">Perfil</a>
        </li>
        <li class="nav-item">
            ...
            <div class="card-body">
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-9 text-secondary">
                  ...
                  <a href="../recuperar senha/senha-esquecida-email.php?rota=dados-pessoais"><input type="button" class="btn btn-primary"
