...
// Mensagem de erro
  if (isset($_GET['error'])){
    $mensagem = "Id de máquina inválido!";
  }
...
<body>
  ...
  <div class="container" style="height: 100%;">
    ...
    <?php if (isset($mensagem)){
        echo "<h3 class='text-left text-center text-danger' >$mensagem</h3>";
    } else {
        echo "<h5 class='text-left text-center text-success'>Digite o código do QR Code ou escaneie-o clicando no botão 'Escanear QR Code' abaixo (caso você esteja usando o celular)</h5>";
    } ?>
    </div>
    <!-- Barra de pesquisas -->
