      ...
      <div class="container">
        ...
        <div class="navbar-collapse collapse" id="navbarsExample05" style="margin-top: 1%;">
          <ul class="navbar-nav ml-auto pl-lg-5 pl-0">
            <li class="nav-item">
              <a class="nav-link " href="menu.html">Início</a>
            </li>
            <li class="nav-item">
              <a class="nav-link active" href="dados-pessoais.html">Dados Pessoais</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="relatar.html">Relatar</a>
            </li>
            <li class="nav-item">
          ...
          <div class="card mt-3">
            <ul class="list-group list-group-flush">
              ...
              <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                ...
                <span class="text-secondary"><?php echo $reltorios ?> Envios</span>
              </li>
            ...
            <div class="card-body">
              <div class="row mb-3">
                ...
                <div class="col-sm-9 text-secondary">
                  <input type="text" class="form-control" value="<?php echo $nome ?>" id="itnome">
                </div>
              </div>
              <div class="row mb-3">
                <div class="col-sm-3">
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-9 text-secondary">
                  <select class="form-control" placeholder="Período" type="text" id="itperiodo">
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-9 text-secondary">
                  <input type="text" class="form-control" value="<?php echo $email ?>" id="itemail">
                </div>
              </div>
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-9 text-secondary">
                  <input type="text" class="form-control" value="<?php echo $senha ?>" disabled>
